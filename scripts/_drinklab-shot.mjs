...
const OUT = process.argv[2] || '/private/tmp/claude-501/-Users-mini-Downloads-super-agent-party-main/0572baa5-322f-44b8-9b23-885f11fdafa9/scratchpad/drink-lab.png';
const PORT = 8901;
...
await page.goto(`http://127.0.0.1:${PORT}/world.html?drinklab=1`, { waitUntil: 'load' });
await page.waitForTimeout(2800);
const r = await page.evaluate(() => {
    const L = window.__foodlab; if (!L) return 'no __foodlab';
    L.controls.target.set(2.25, 18.1, 0); L.camera.position.set(2.25, 22.4, 10.2); L.controls.update();
