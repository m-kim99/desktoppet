...
const OUT = process.argv[2] || '/private/tmp/claude-501/-Users-mini-Downloads-super-agent-party-main/0572baa5-322f-44b8-9b23-885f11fdafa9/scratchpad/snack-lab.png';
const PORT = 8904;
...
await page.goto(`http://127.0.0.1:${PORT}/world.html?snacklab=1`, { waitUntil: 'load' });
await page.waitForTimeout(2800);
const r = await page.evaluate(() => {
    const L = window.__foodlab; if (!L) return 'no __foodlab';
    L.controls.target.set(3.9, 19.2, 0); L.camera.position.set(3.9, 21.6, 16.2); L.controls.update();
