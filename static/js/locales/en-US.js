window.lang_enUS = {
        ...
        'customUrlHint': 'The URL must start with http:// or https://. Enter your API key in the API key field below.',
      ...
      'bodyPlaceholder': `Enter the body in JSON Schema format. For example:
{
    ...
    "required": ["name", "age"]
        ...
        'textInputHotkey': 'Text Input Hotkey',
        'textInputHotkeyHint': 'On the desktop-pet screen, pressing this global hotkey opens the input box below the character. Default is F13 (no physical key on MacBooks, so no conflicts). Examples: F13, F7, CommandOrControl+Shift+Space. Restart the desktop pet for changes to take effect.',
        'textInputHotkeyPlaceholder': 'e.g. F13',
        'showPetHotkey': "Show Character Hotkey",
        'hidePetHotkey': "Hide Character Hotkey",
        ...
        'worldReplyRules': 'Reply Rules',
        'worldActionSpec': 'Action Tag Spec',
        'worldActionSpecHint': 'The action tags the pet may use. Tag IDs must match what the world actually supports (unknown tags are ignored).',
        'worldMailPersona': 'Mailbox Reply Persona',
        'idleTalkLines': 'Remark List',
        'idleTalkLinesPlaceholder': "One remark per line.\ne.g.) I'm bored~\nWhat should we do today?\nAre you there?",
        'idleTalkHint': 'When the character is idle, one of the remarks above is shown at random in the speech bubble. It never interrupts active chat/speech, and the interval has some randomness. (Re-summon the character window to apply.)',
        'wanderEnabled': 'Idle Wandering',
        'wanderInterval': 'Wander Interval (sec)',
        'wanderRange': 'Wander Range (px)',
        'wanderHint': 'When the character is idle, it occasionally slides to a nearby spot on screen (playing a walk motion if one exists). It stays within the screen and never moves during chat/speech or while the input box is open. The interval has some randomness. (Re-summon the character window to apply.)',
...
Key3`,
        ...
        'globalMemoryPlaceholder': "Enter things the AI should always remember. e.g.: I speak Korean and prefer concise answers.",
        'globalMemoryHint': "Whatever you write here is always injected as a system message in every conversation, regardless of the selected character or whether memory is on. {{user}} is replaced with the username.",
        ...
        'allowedSendersLabel': 'Allowed Senders (Security)',
        'allowedSendersHint': 'If left empty, anyone can talk to the bot (security risk). Add your own ID to only process messages from listed senders. Send /id to the bot to find your own ID.',
        'allowedSendersPlaceholder': 'Enter an allowed chat ID and press Enter (empty = allow all)',
        'allowedUserIdPlaceholder': 'Enter an allowed user ID and press Enter (empty = allow all)',
        ...
        'NoNextModel': 'No next model',
        'NoPreviousModel': 'No previous model',
        'vrmTextInputPlaceholder': 'Type a message to chat with the character...',
        'notifyScreenshotFailed': "Screenshot failed, check the console",
        'notifyDownloadFailedConsole': "Download failed, check the console",
        'notifyConnectingTelegram': "Connecting to the Telegram bot...",
        'notifyTelegramStarted': "Telegram bot started",
        'notifyTelegramStopped': "Telegram bot stopped",
        'notifyTelegramReloaded': "Telegram bot reloaded",
        'notifyConnectingDiscord': "Connecting to the Discord bot...",
        'notifyDiscordStarted': "Discord bot started",
        'notifyDiscordStopped': "Discord bot stopped",
        'notifyDiscordReloaded': "Discord bot reloaded",
        'notifyConnectingSlack': "Connecting to the Slack bot...",
        'notifySlackStarted': "Slack bot started",
        'notifySlackStopped': "Slack bot stopped",
        'notifySlackReloaded': "Slack bot reloaded",
        'notifyNetworkErrorOrNoResponse': "Network error or no server response",
        'notifyNetworkError': "Network error",
        'notifyServerConnected': "Server connected",
        'notifyComfyuiConnectFailed': "Could not connect to the ComfyUI server",
        'notifyDeleteSuccess': "Deleted successfully",
        'notifyDeleteFailed': "Delete failed",
        'notifyUploadSuccess': "Upload succeeded",
        'notifyUploadFailed': "Upload failed",
        'notifyVoiceServerConnectFailed': "Could not connect to the voice server",
        'notifySelectAudioFirst': "Please select an audio file first",
        'notifyRefAudioUploaded': "Reference audio uploaded",
        'notifyUploadFailedNetwork': "Upload failed, check your network connection",
        'notifyAudioDeleted': "Audio deleted",
        'notifyDeleteFailedRetry': "Delete failed, please try again later",
        'notifyOnlyVrm': "Only .vrm files are supported",
        'notifySelectVrmFirst': "Please select a VRM model file first",
        'notifyEnterModelName': "Please enter a model display name",
        'notifyVrmUploaded': "VRM model uploaded",
        'notifyCannotDeleteDefaultModel': "Cannot delete the default model",
        'notifyVrmDeleted': "VRM model deleted",
        'notifyOnlyVrma': "Only .vrma files are supported",
        'notifySelectVrmaFirst': "Please select a VRMA motion file first",
        'notifyEnterMotionName': "Please enter a motion display name",
        'notifyVrmaUploaded': "VRMA motion uploaded",
        'notifyUnsupportedFileType': "Unsupported file type",
        'notifySceneUploaded': "Scene uploaded",
        'notifySceneDeleted': "Scene deleted",
        'notifySelectDirFailed': "Failed to select directory",
        'notifyEnterGithubUrl': "Please enter a GitHub URL",
        'notifyDownloadingBackground': "Downloading in the background, please wait...",
        'notifyDownloadStarted': "Download started, please be patient...",
        'notifyInstallSuccess': "Installation succeeded!",
        'notifyVtsTimeout': "VTS connection timed out; check whether the backend is running",
        'notifyCommandSendFailed': "Failed to send command, check your network",
        'notifyDesktopOnly': "Desktop-only operation",
        'notifyResetFailed': "Reset failed",
        'notifyPathNotLoaded': "Path not loaded yet",
        'notifyStartFailedColon': "Start failed: ",
        'notifyStopFailedColon': "Stop failed: ",
        'notifyReloadFailedColon': "Reload failed: ",
        'notifyUploadFailedColon': "Upload failed: ",
        'notifyDeleteFailedColon': "Delete failed: ",
        'notifyPluginStartFailedColon': "Plugin service failed to start: ",
        'notifyPluginRequestError': "Plugin service request error: ",
        'notifyInstallFailedColon': "Installation failed: ",
        'notifyVtsConnected': "VTube Studio connected",
        'notifyModifyFailed': "Modify failed",
        'notifyResetAllOptions': "All options have been reset",
        'selectOrEnterResourceId': "Select or enter a Resource ID",
        'enterExactUsername': "Please enter the exact username",
        'selectFolder': "Select Folder",
        'refreshData': "Refresh data",
        'browseDirectory': "Browse directory",
        'shortcutRegisterFailedPrefix': "Global shortcut ",
        'shortcutRegisterFailedSuffix': " failed to register; it may be in use by the system or another app",
        'getVoiceListFailed': "Failed to get the system voice list: ",
        'exportFailed': "Export failed",
        'confirmDeleteSkillFile': "This will permanently delete this skill file. Continue?",
        'operationFailedConsole': "Operation failed, check the console log",
        'affectionLoadFailed': "Could not load affection data; check that the backend is running",
        'affectionSynced': "Affection data synced",
        'affectionSaveFailed': "Failed to save affection data",
        'usernameExists': "That username already exists!",
        'exportFailedRetry': "Export failed, please try again",
        'readDirError': "Failed to read directory",
        'audioProcessingStarted': "Processing audio...",
        'cancelSuccess': "Task cancelled",
        'connectionTimeout': "Connection timeout",
        'xrNotSupported': 'Your browser does not support any XR configuration. Please try the latest version of Chrome.',
        'errorLabel': 'Error',
