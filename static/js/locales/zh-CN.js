window.lang_zhCN = {
        ...
        'pleaseSelect': '请选择',
        'customURL': '自定义URL',
        'customUrlHint': '地址必须以 http:// 或 https:// 开头。API密钥请填写在下方的API密钥输入框中。',
      ...
      'bodyPlaceholder': `请输入请求体，使用JSON Schema格式。例如：
{
    ...
    "required": ["name", "age"]
        ...
        'textInputHotkey': '文字输入快捷键',
        'textInputHotkeyHint': '在桌面宠物界面按下该全局快捷键即可打开角色下方的输入框。默认 F13（MacBook 无物理键，不会冲突）。例如：F13、F7、CommandOrControl+Shift+Space。修改后需重新启动桌面宠物才能生效。',
        'textInputHotkeyPlaceholder': '例如：F13',
        'showPetHotkey': "召唤角色快捷键",
        'hidePetHotkey': "隐藏角色快捷键",
        ...
        'worldLore': '世界观 / 背景',
        'worldReplyRules': '回复规则',
        'worldActionSpec': '行为标签规范',
        'worldActionSpecHint': '宠物可用的行为标签列表。标签 ID 必须与世界实际支持的一致才生效（未知标签会被忽略）。',
        'worldMailPersona': '信箱回信性格',
        'idleTalkLines': '发言列表',
        'idleTalkLinesPlaceholder': '每行一句。\n例如）好无聊~\n今天做点什么呢？\n你在吗？',
        'idleTalkHint': '角色处于闲置状态时，会随机从以上发言中挑选一句显示在气泡里。不会打断正在进行的对话/语音，间隔带有一定随机性。（需重新召唤角色窗口以生效）',
        'wanderEnabled': '闲置漫游',
        'wanderInterval': '漫游间隔（秒）',
        'wanderRange': '漫游范围（px）',
        'wanderHint': '角色处于闲置状态时，会偶尔滑动到屏幕上附近的位置（若有走路动作则一并播放）。不会移出屏幕，且在对话/语音或输入框打开时不会移动。间隔带有一定随机性。（需重新召唤角色窗口以生效）',
...
key3`,
        ...
        'globalMemory': "全局记忆",
        'globalMemoryPlaceholder': "输入希望AI始终记住的内容。例如：我使用韩语，偏好简洁的回答。",
        'globalMemoryHint': "此处填写的内容会作为系统消息始终注入到每次对话中，与所选角色或是否开启记忆无关。{{user}} 会被替换为用户名。",
        ...
        'allowedSendersLabel': '允许的发送者（安全）',
        'allowedSendersHint': '留空则任何人都能与机器人对话（存在安全风险）。添加你自己的 ID 后，仅处理列表内发送者的消息。向机器人发送 /id 可获取你自己的 ID。',
        'allowedSendersPlaceholder': '输入允许的 chat ID 后回车（留空 = 允许所有人）',
        'allowedUserIdPlaceholder': '输入允许的 user ID 后回车（留空 = 允许所有人）',
        ...
        'NoNextModel': '没有下一个模型',
        'NoPreviousModel': '没有上一个模型',
        'vrmTextInputPlaceholder': '输入文字与模型对话...',
        'notifyScreenshotFailed': "截图失败，请检查控制台",
        'notifyDownloadFailedConsole': "下载失败，请检查控制台",
        'notifyConnectingTelegram': "正在连接 Telegram 机器人...",
        'notifyTelegramStarted': "Telegram 机器人启动成功",
        'notifyTelegramStopped': "Telegram 机器人已停止",
        'notifyTelegramReloaded': "Telegram 机器人已重载",
        'notifyConnectingDiscord': "正在连接 Discord 机器人...",
        'notifyDiscordStarted': "Discord 机器人启动成功",
        'notifyDiscordStopped': "Discord 机器人已停止",
        'notifyDiscordReloaded': "Discord 机器人已重载",
        'notifyConnectingSlack': "正在连接 Slack 机器人...",
        'notifySlackStarted': "Slack 机器人启动成功",
        'notifySlackStopped': "Slack 机器人已停止",
        'notifySlackReloaded': "Slack 机器人已重载",
        'notifyNetworkErrorOrNoResponse': "网络错误或服务器未响应",
        'notifyNetworkError': "网络错误",
        'notifyServerConnected': "服务器连接成功",
        'notifyComfyuiConnectFailed': "无法连接ComfyUI服务器",
        'notifyDeleteSuccess': "删除成功",
        'notifyDeleteFailed': "删除失败",
        'notifyUploadSuccess': "上传成功",
        'notifyUploadFailed': "上传失败",
        'notifyVoiceServerConnectFailed': "无法连接语音服务器",
        'notifySelectAudioFirst': "请先选择音频文件",
        'notifyRefAudioUploaded': "参考音频上传成功",
        'notifyUploadFailedNetwork': "上传失败，请检查网络连接",
        'notifyAudioDeleted': "音频已删除",
        'notifyDeleteFailedRetry': "删除失败，请稍后再试",
        'notifyOnlyVrm': "只支持.vrm格式的文件",
        'notifySelectVrmFirst': "请先选择VRM模型文件",
        'notifyEnterModelName': "请输入模型显示名称",
        'notifyVrmUploaded': "VRM模型上传成功",
        'notifyCannotDeleteDefaultModel': "无法删除默认模型",
        'notifyVrmDeleted': "VRM模型已删除",
        'notifyOnlyVrma': "只支持.vrma格式的文件",
        'notifySelectVrmaFirst': "请先选择VRMA动作文件",
        'notifyEnterMotionName': "请输入动作显示名称",
        'notifyVrmaUploaded': "VRMA动作上传成功",
        'notifyUnsupportedFileType': "不支持的文件类型",
        'notifySceneUploaded': "场景上传成功",
        'notifySceneDeleted': "场景已删除",
        'notifySelectDirFailed': "选择目录失败",
        'notifyEnterGithubUrl': "请输入 GitHub 地址",
        'notifyDownloadingBackground': "正在后台下载，请稍候...",
        'notifyDownloadStarted': "已开始下载，请耐心等待...",
        'notifyInstallSuccess': "安装成功！",
        'notifyVtsTimeout': "VTS 连接超时，请检查后端程序是否运行",
        'notifyCommandSendFailed': "指令发送失败，请检查网络",
        'notifyDesktopOnly': "仅支持桌面端操作",
        'notifyResetFailed': "重置失败",
        'notifyPathNotLoaded': "路径尚未加载",
        'notifyStartFailedColon': "启动失败：",
        'notifyStopFailedColon': "停止失败：",
        'notifyReloadFailedColon': "重载失败：",
        'notifyUploadFailedColon': "上传失败: ",
        'notifyDeleteFailedColon': "删除失败: ",
        'notifyPluginStartFailedColon': "插件服务启动失败: ",
        'notifyPluginRequestError': "请求插件服务异常: ",
        'notifyInstallFailedColon': "安装失败: ",
        'notifyVtsConnected': "VTube Studio 已连接",
        'notifyModifyFailed': "修改失败",
        'notifyResetAllOptions': "已重置所有选项",
        'selectOrEnterResourceId': "选择或输入 Resource ID",
        'enterExactUsername': "请输入准确的用户名",
        'selectFolder': "选择文件夹",
        'refreshData': "刷新数据",
        'browseDirectory': "浏览目录",
        'shortcutRegisterFailedPrefix': "全局快捷键 ",
        'shortcutRegisterFailedSuffix': "  注册失败，可能被系统或其他软件占用",
        'getVoiceListFailed': "获取系统音色列表失败: ",
        'exportFailed': "导出失败",
        'confirmDeleteSkillFile': "此操作将彻底删除该技能文件，是否继续？",
        'operationFailedConsole': "操作失败，请检查控制台日志",
        'affectionLoadFailed': "无法加载羁绊数据，请检查后端是否正常运行",
        'affectionSynced': "羁绊数据已同步",
        'affectionSaveFailed': "羁绊数据保存失败",
        'usernameExists': "该用户名已存在！",
        'exportFailedRetry': "导出失败，请重试",
        'readDirError': "读取目录失败",
        'audioProcessingStarted': "正在处理音频...",
        'cancelSuccess': "取消任务成功",
        'connectionTimeout': "连接超时",
        'xrNotSupported': '您的浏览器不支持任何 XR 配置，请尝试使用最新版 Chrome 浏览器。',
        'errorLabel': '报错',
